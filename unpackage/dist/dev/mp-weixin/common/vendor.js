...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__ANKANG_FAMILY_CARE",
    appName: "安康家庭养老助手",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "172.16.13.73,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_WADn8L";
...
function fullKey(key) {
  const appid = "__UNI__ANKANG_FAMILY_CARE";
...
function getVue3TitleMap() {
  ...
  titleMapCache = {};
  try {
    const raw = '{"pages/family/reminder-edit/index":"提醒设置","pages/family/member/index":"家庭成员","pages/family/task/index":"照护任务"}';
...
function getAppId$1() {
  var _a;
  return (_a = "__UNI__ANKANG_FAMILY_CARE") !== null && _a !== void 0 ? _a : "";
}
...
function getMpTdaid(platform) {
  ...
  switch (platform) {
    ...
    case "qq": {
      ...
      const envId = "__UNI__ANKANG_FAMILY_CARE";
...
function getEnvAppName() {
  var _a;
  return (_a = "安康家庭养老助手") !== null && _a !== void 0 ? _a : "";
}
...
function getPackageInfo() {
  ...
  if (isApp()) {
    ...
    pkn = "";
    an = getEnvAppName();
    mpn = tdaid || "__UNI__ANKANG_FAMILY_CARE";
  } else if (isH5()) {
    tdaid = "";
    pkn = "";
    an = getH5AppName();
...
function getAppId() {
  const id = "__UNI__ANKANG_FAMILY_CARE";
  if (id.length > 0)
    return id;
  return "default";
}
